...
if __name__ == "__main__":
    ...
    (junk,fastafile,start, end,boundary,massFile)=sys.argv

    start=int(start)
    end=int(end)
    fasta=readFasta(fastafile,start,end)
    #print(fasta)

    boundary=readBoundari(boundary)
    #print(boundary)
    
    massMap=MassMap()
    #print(massMap)

    MList=CAmass(massMap,fasta,boundary)
    #print(MList)
